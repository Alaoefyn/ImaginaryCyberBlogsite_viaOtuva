...
// close modal. add esc support too
...
const blog = new Gallery(getElement('.blog-page'));
const index = new Gallery(getElement('.index-page'));
const other = new Gallery(getElement('.other'));


// key support
// ok tuslari
// hit escape to close modal
const modalKeyControl = e => {
  if (e.key === 'Escape') {
    blog.closeModal();
  }
...
document.addEventListener('keydown', modalKeyControl);